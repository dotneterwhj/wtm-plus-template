...
<el-card shadow="hover" class="layout-padding-auto" >
        ...
        <el-form ref="formRef" :model="state.vmModel"  label-width="90px" >
			<WtmImportor  url="/api/_Admin/FrameworkUser/GetExcelTemplate" v-model="state.vmModel.UploadFileId" :files="state.vmModel.files"/>
...
<script setup lang="ts" name="message.autotrans._Page_AdminFrameworkUserImport;false">
